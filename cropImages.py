...
# Paths
files_dir = Path(r"C:\Users\lasheb\PycharmProjects\MALIN-extraction-with-images\files")  # Original images
detnum_folder = Path("output/detImages/predict")  # JSON folder
